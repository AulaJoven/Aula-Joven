...
router.post("/users/:id/resend-email", ...admin, resendWelcomeEmail);
...
router.delete(
  "/grupos/:id/estudiantes/:estudianteId",
  ...admin,
  desinscribirEstudiante,
);
...
// ── Asistencias ────────────────────────────────────────────────────────────
router.get(
  "/grupos/:id/estudiantes/:estudianteId/asistencia",
  ...admin,
  getAsistencia,
);
router.post(
...
router.delete(
  "/grupos/:id/estudiantes/:estudianteId/asistencia/:registroId",
  ...admin,
  eliminarAsistencia,
);
