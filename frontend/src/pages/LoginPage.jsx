  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm mx-4">
        <div className="bg-[#FFFDF0] rounded-2xl px-8 py-10 flex flex-col items-center"
          style={{ boxShadow: '0 8px 40px rgba(0,0,0,0.3)' }}>

          {/* Logo */}
          <img src={logoFundacion} alt="Fundación Curridabat" className="w-32 h-32 object-contain mb-6" />
          ...
          <form onSubmit={handleSubmit} className="w-full space-y-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <label htmlFor="remember" className="text-xs text-slate-500 cursor-pointer">Recordar sesión</label>
            </div>
